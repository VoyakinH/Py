...
def output_1(event):
    ...
    ok = True
    try:
        if (x[0] == '-' and x[1] == '.') or ( x[0] == '.') or(x[len(x)] == '.'):
            ok = False
            error_1()
        else:
            y = str(x)
...
# Выводит сообщение об ошибки при переводе в четверичную
def error_1():
    messagebox.showinfo('Ошибка', "Некорректный ввод.")


# Выводит сообщение об ошибке при переводе в десятичную
def error_2():
    messagebox.showinfo("Ошибка", "Введены недопустимые символы для четверичной с/с")
...
def switch_1():
    ...
    lbl3['text'] = "Число знаков за запятой"
...
txt = Entry(window, textvariable=sv, validate="all", validatecommand=clr_2, width=21)
...
switch_1()
lbl4 = Label(window, font=('Arial Bold', 16), text='    ')
lbl4.grid(column=3, row=1)
k1 = Button(window, text="1", font=("Arial Bold", 10))
k1.grid(column=4, row=1)
k2 = Button(window, text="2", font=("Arial Bold", 10))
k2.grid(column=5, row=1)
k3 = Button(window, text="3", font=("Arial Bold", 10))
k3.grid(column=6, row=1)
k4 = Button(window, text="4", font=("Arial Bold", 10))
k4.grid(column=4, row=2)
k5 = Button(window, text="5", font=("Arial Bold", 10))
k5.grid(column=5, row=2)
k6 = Button(window, text="6", font=("Arial Bold", 10))
k6.grid(column=6, row=2)
k7 = Button(window, text="7", font=("Arial Bold", 10))
k7.grid(column=4, row=3)
k8 = Button(window, text="8", font=("Arial Bold", 10))
k8.grid(column=5, row=3)
k9 = Button(window, text="9", font=("Arial Bold", 10))
k9.grid(column=6, row=3)
kt = Button(window, text=" .", font=("Arial Bold", 10))
kt.grid(column=4, row=4)
k0 = Button(window, text="0", font=("Arial Bold", 10))
k0.grid(column=5, row=4)
km = Button(window, text=" -", font=("Arial Bold", 10))
km.grid(column=6, row=4)
kdel = Button(window, text="Delete", font=("Arial Bold", 13))
kdel.grid(column=4, row=5, columnspan=3)
...
btn2 = Button(window, text='Сменить', font=('Arial Bold', 9))
btn2.grid(column=4, row=0, columnspan=3)
btn2.bind("<Button-1>", swit)
window.mainloop()
